...
│   │   ├── drizzle/             ★ CANONICAL SQL migrations (0000–0044)
...
| Migrations snapshot | `Aws/migrations/` (0000–0044 + drizzle journal) | **Point-in-time copy for reference only** — `apps/backend/drizzle/` is CANONICAL; always run migrations from there |

...
const NAV_ITEMS: readonly AdminNavItem[] = [
  { id: 'dashboard', href: '/admin', label: 'Dashboard', icon: LayoutDashboard, permission: 'ops.live' },
  { id: 'verification', href: '/admin/drivers', label: 'Verification', icon: FileSearch, permission: 'kyc.read' },
  { id: 'ops', href: '/admin/ops', label: 'Live Ops', icon: Map, permission: 'ops.live' },
  { id: 'bookings', href: '/admin/bookings', label: 'Bookings', icon: Briefcase, permission: 'booking.read' },
  { id: 'disputes', href: '/admin/disputes', label: 'Disputes', icon: Scale, permission: 'dispute.handle' },
  { id: 'users', href: '/admin/users', label: 'Users', icon: Users, permission: 'user.read' },
  { id: 'drivers', href: '/admin/drivers/list', label: 'Drivers', icon: Car, permission: 'user.read' },
  { id: 'fleets', href: '/admin/fleets', label: 'Fleets', icon: ShieldCheck, permission: 'user.read' },
  { id: 'finance', href: '/admin/finance', label: 'Finance', icon: Wallet, permission: 'finance.read' },
  { id: 'pricing', href: '/admin/pricing', label: 'Pricing', icon: Tags, permission: 'pricing.edit' },
  { id: 'commission', href: '/admin/commission', label: 'Commission', icon: Percent, permission: 'commission.edit' },
  { id: 'dispatch', href: '/admin/dispatch', label: 'Dispatch', icon: Compass, permission: 'dispatch.config' },
  { id: 'zones', href: '/admin/zones', label: 'Zones', icon: Gauge, permission: 'zone.edit' },
  { id: 'promotions', href: '/admin/promotions', label: 'Promotions', icon: Megaphone, permission: 'promo.manage' },
  { id: 'support', href: '/admin/support', label: 'Support', icon: LifeBuoy, permission: 'ticket.handle' },
  { id: 'sos', href: '/admin/sos', label: 'SOS', icon: ShieldAlert, permission: 'sos.handle' },
  { id: 'analytics', href: '/admin/analytics', label: 'Analytics', icon: BarChart3, permission: 'analytics.export' },
  { id: 'privacy', href: '/admin/privacy', label: 'Privacy', icon: ShieldCheck, permission: 'privacy.handle' },
  { id: 'admins', href: '/admin/admins', label: 'Admins', icon: CreditCard, permission: 'admin.manage' },
  ...
  { id: 'settings', href: '/admin/settings/security', label: 'Settings', icon: Settings, permission: null },
];
